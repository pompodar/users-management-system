...
// Focusing on Input in Adding and Editing Form
...
// Submitting Adding and Editing Form
...
$("#submit").on("click", async function(event) {
  ...
  if (action == "add") {
    ...
    document.getElementById("name" + edit_id).innerHTML =
      $("#fname").val() + " " + $("#lname").val();
...
// Preventing Adding and Editing Form to submit

$("#form").submit(function(evt) {
  evt.preventDefault();
});

// Closing Adding and Editing Form
